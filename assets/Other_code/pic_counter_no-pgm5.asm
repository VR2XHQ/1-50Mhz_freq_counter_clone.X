; Zero moved from D3 to D4 - ok
; PGM mode disabled - ok
; RA5 = D5 - error!! - RA5 is input only
; Removed edit routines - ok
; 9 & 6 changed
...
; AUTHOR:    Wolfgang "Wolf" B�scher, DL4YHF                              *
...
; EX(16F84:)     __CONFIG   _CP_OFF & _WDT_ON & _PWRTE_ON & _RC_OSC
   ...
   __CONFIG   _CP_OFF & _WDT_ON & _PWRTE_ON & _HS_OSC & _LVP_OFF & _BODEN_OFF & _MCLRE_ON
#endif
...
Digit2SevenSeg:
 ...
 #define SSEG_XORMASK 0x00  ; for COMMON CATHODE: No bitwise EXOR to the pattern
          ...
          retlw (      _C+_D+_E+_F+_G)^SSEG_XORMASK ; ..CDEFG = '6'    ( # 6  )
          retlw (_A+_B+_C            )^SSEG_XORMASK ; ABC.... = '7'    ( # 7  )
          retlw (_A+_B+_C+_D+_E+_F+_G)^SSEG_XORMASK ; ABCDEFG = '8'    ( # 8  )
          retlw (_A+_B+_C      +_F+_G)^SSEG_XORMASK ; ABC..FG = '9'    ( # 9  )
